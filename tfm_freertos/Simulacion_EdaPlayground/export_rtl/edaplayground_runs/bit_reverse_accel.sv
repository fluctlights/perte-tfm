...
`include "bit_reverse_accel_hls_deadlock_idx0_monitor.v"
`include "bit_reverse_accel_regslice_both.v"

`timescale 1 ns / 1 ps 

(* CORE_GENERATION_INFO="bit_reverse_accel_bit_reverse_accel,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200t-fbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=2.000000,HLS_SYN_LAT=4,HLS_SYN_TPT=4,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=5,HLS_SYN_LUT=74,HLS_VERSION=2023_2}" *)
