...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../tfm_freertos.gen/sources_1/bd/design_1/ipshared/f352/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fluctlights/VivadoProjects/tfm_freertos/tfm_freertos.cache/compile_simlib/xcelium"
  fi
