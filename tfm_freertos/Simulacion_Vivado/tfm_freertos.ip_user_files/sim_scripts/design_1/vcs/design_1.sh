...
#
# Script generated by Vivado on Sat Aug 16 21:24:36 CEST 2025
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../tfm_freertos.gen/sources_1/bd/design_1/ipshared/f352/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fluctlights/VivadoProjects/tfm_freertos/tfm_freertos.cache/compile_simlib/vcs"
  fi
