...
\centering
  \begin{tabular}{|l|p{7cm}|p{6cm}|}
    ...
    \hline
    \textbf{Desarrollador} & EPFL ESL Lab & VISI Lab, Universidad de Bologna \\
    \hline
    \textbf{Repositorio} & \texttt{esl-epfl/x-heep} & \texttt{visi-lab/GR-HEEP} \\
    \hline
    \textbf{Propósito} & Exploración de aceleradores de ultra-baja potencia & Plataforma genérica para prototipado rápido \\
    \hline
    \textbf{Complejidad} & Diseño minimalista y esencial & Más complejo con periféricos adicionales \\
    \hline
    \textbf{Extensibilidad} & Diseñado para extensión desde cero & Pre-extendido pero aún modificable \\
    \hline
    \textbf{Configuración} & Mediante \texttt{mcu-gen} y archivos JSON & Hereda de X-HEEP con configuraciones adicionales \\
    \hline
    \textbf{Periféricos} & Básicos, orientados a investigación & Amplia gama (UART, I2C, SPI, etc.) \\
    \hline
    \textbf{Caso de uso} & Investigación y desarrollo personalizado & Aplicaciones prácticas e integración rápida \\
    \hline
  \end{tabular}
...
En lo que respecta a su arquitectura, el diseño modular de GR-HEEP, al igual que el de X-HEEP, está dividido en distintos dominios de energía (CPU, periféricos, memoria, always-on), optimizando el consumo y permitiendo habilitar/deshabilitar componentes según necesidad. Emplea cores del OpenHW Group como CVE2, CV32E40P(X), todos RISC-V de 32 bits estilo Harvard y sin cache, ideales para escenarios ultra-low-power y RTOS integrados \cite{xheepDocs}. Finalmente, en la figura \ref{fig:xheepArch} se presenta un diagrama de la arquitectura de X-HEEP, sobre la que se basa GR-HEEP en cuestión.
