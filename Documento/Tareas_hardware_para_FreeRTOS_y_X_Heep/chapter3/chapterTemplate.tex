...
\label{sec:objetivos}
El objetivo principal del proyecto será, tal y como se ha introducido en \ref{sec:objetivos}, \textbf{la implementación e integración en X-HEEP/GR-HEEP de un acelerador AXI-Stream en hardware}, que sea funcional, y en la medida posible, utilizando metodologías basadas en herramientas EDA, y más eficiente que una versión realizada en software para el mismo propósito. Para el cumplimiento de este objetivo, se tienen una serie de objetivos parciales:

\begin{enumerate}
    \item \emph{La validación del diseño mediante simulaciones y ejecuciones}, que permita verificar la funcionalidad del diseño realizado, empleado para ello herramientas de simulación y de ejecución que permitan obtener datos acerca del correcto funcionamiento del mismo.
    ...
    \item \emph{La realización de comparativas de rendimiento frente a una versión \textit{software}} del algoritmo que finalmente sea seleccionado para ser acelerado por \textit{hardware}.
\end{enumerate}
