...
#define RAM5_START_ADDRESS 0x00020000
#define RAM5_END_ADDRESS 0x00028000
...
#define DMA_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x00030000)
...
#define FAST_INTR_CTRL_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x00060000)
...
#define EXT_PERIPHERAL_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x00070000)
...
#define PAD_CONTROL_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x00080000)
...
#define GPIO_AO_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x00090000)
#define GPIO_AO_SIZE 0x00010000
#define GPIO_AO_END_ADDRESS (GPIO_AO_START_ADDRESS + GPIO_AO_SIZE)
#define GPIO_AO_IDX 10

#define UART_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x000A0000)
...
#define SPI_HOST_START_ADDRESS (PERIPHERAL_START_ADDRESS + 0x00010000)
