...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo2axis is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo2axis;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo2axis is
  ...
  attribute SOFT_HLUTNM of \buffer[0][31]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \next_state[0]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \next_state[0]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \next_state[1]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \next_state[2]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of s_axis_tvalid_i_1 : label is "soft_lutpair0";
begin
\buffer[0][31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
\buffer[1][31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\buffer[2][31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\buffer[3][31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\buffer_index[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo2axis
     port map (
      clk => clk,
