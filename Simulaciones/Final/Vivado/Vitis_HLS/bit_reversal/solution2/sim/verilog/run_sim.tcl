...
if {[file isfile bit_reverse_accel.autotvin.dat]} {
	file delete -force bit_reverse_accel.autotvin.dat
}

if {[file isfile bit_reverse_accel.autotvout.dat]} {
	file delete -force bit_reverse_accel.autotvout.dat
}
