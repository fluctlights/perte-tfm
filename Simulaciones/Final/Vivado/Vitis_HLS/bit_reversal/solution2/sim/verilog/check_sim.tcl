...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.bit_reverse_accel.autotvin_s_axis_V_data_V.dat"
         "c.bit_reverse_accel.autotvin_s_axis_V_keep_V.dat"
         "c.bit_reverse_accel.autotvin_s_axis_V_strb_V.dat"
         "c.bit_reverse_accel.autotvin_s_axis_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.bit_reverse_accel.autotvout_m_axis_V_data_V.dat"
         "rtl.bit_reverse_accel.autotvout_m_axis_V_keep_V.dat"
         "rtl.bit_reverse_accel.autotvout_m_axis_V_strb_V.dat"
         "rtl.bit_reverse_accel.autotvout_m_axis_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
