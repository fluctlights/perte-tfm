...
$(ObjDir)/bit_reversal_accel.cpp_pre.cpp.tb.o : bit_reversal_accel.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bit_reversal_accel.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
