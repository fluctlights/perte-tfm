...
# RegSlice definition:
set ID 9
set RegSliceName bit_reverse_accel_regslice_both
set RegSliceInstName bit_reverse_accel_regslice_both_U
set CoreName ap_simcore_bit_reverse_accel_regslice_both
...
set InstName bit_reverse_accel_flow_control_loop_pipe_U
set CompName bit_reverse_accel_flow_control_loop_pipe
