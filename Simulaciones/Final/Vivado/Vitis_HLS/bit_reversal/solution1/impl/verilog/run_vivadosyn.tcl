...
set ip_vlnv xilinx.com:hls:bit_reverse_accel:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project bit_reversal
...
dict set report_options bindmodules {bit_reverse_accel_regslice_both bit_reverse_accel_flow_control_loop_pipe}
